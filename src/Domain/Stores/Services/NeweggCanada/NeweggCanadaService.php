...
class NeweggCanadaService implements StoreContract
{
    ...
    {
        Assert::allContains($uris, 'newegg.ca');
        $prefix = Config::get('store.Domain\Stores\Services\NeweggCanada\NeweggCanadaService.image_prefix');
    ...
    {
        return $store === Store::NeweggCanada;
    }
}
